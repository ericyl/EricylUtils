...
//            }
//        }
        if (buildBarcodeFragment != null)
            buildBarcodeFragment.onActivityResult(requestCode, resultCode, data);
        if (scanBarcodeFragment != null)
            scanBarcodeFragment.onActivityResult(requestCode, resultCode, data);
...
//        }
        if (buildBarcodeFragment != null)
            buildBarcodeFragment.onRequestPermissionsResult(requestCode, permissions, grantResults);
        if (scanBarcodeFragment != null)
            scanBarcodeFragment.onRequestPermissionsResult(requestCode, permissions, grantResults);
    }
