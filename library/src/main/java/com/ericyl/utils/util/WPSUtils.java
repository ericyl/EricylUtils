...
public class WPSUtils {
    ...
    public static final String PACKAGENAME_HW2 = "cn.wps.moffice_i18n";
    ...
    public static final String PACKAGENAME = "cn.wps.moffice"; // 测试版
    ...
    public static final String AT_QUICK_CLOSE_REVISEMODE = "AT_QUICK_CLOSE_REVISEMODE"; // 快速关闭修改
    ...
    public static String decideWPSPackage(@NonNull Context context) {
        if (PackageUtils.findApk(context, PACKAGENAME_ENG))
            return PACKAGENAME_ENG;
        if (PackageUtils.findApk(context, PACKAGENAME_ENT))
            return PACKAGENAME_ENT;
        if (PackageUtils.findApk(context, PACKAGENAME_KING_PRO_HW))
            return PACKAGENAME_KING_PRO_HW;
        if (PackageUtils.findApk(context, PACKAGENAME_HW2))
            return PACKAGENAME_HW2;
        return null;

    }

    public static boolean openWPSFile(@NonNull Context context, @NonNull String packageName,
                                      @NonNull String path) {
